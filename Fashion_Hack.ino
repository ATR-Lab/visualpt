...
void loop()
{
  ...
  if(Serial.available()>0){
    char a =Serial.read();
    if(a == 'a'){
      runBlue(BlUEPIN1, GREENPIN1, BLUEPIN1, 1);
    } 
    if(a == 'b'){
      runBlue(BlUEPIN1, GREENPIN1, BLUEPIN1, 2);
    }
    if(a=='c'){
      runBlue(BlUEPIN1, GREENPIN1, BLUEPIN1, 3);
    }
    if(a=='d'){
    ...
    char b =Serial.read();
    if(b == 'a'){
      runBlue(BlUEPIN2, GREENPIN2, BLUEPIN2, 1);
    } 
    if(b == 'b'){
      runBlue(BlUEPIN2, GREENPIN2, BLUEPIN2, 2);
    }
    if(b=='c'){
      runBlue(BlUEPIN2, GREENPIN2, BLUEPIN2, 3);
    }
    if(b=='d'){
    ...
    char c =Serial.read();
    if(c == 'a'){
      runBlue(BlUEPIN3, GREENPIN3, BLUEPIN3, 1);
    } 
    if(c == 'b'){
      runBlue(BlUEPIN3, GREENPIN3, BLUEPIN3, 2);
    }
    if(c=='c'){
      runBlue(BlUEPIN3, GREENPIN3, BLUEPIN3, 3);
    }
    if(c=='d'){
    ...
    char d =Serial.read();
    if(d == 'a'){
      runBlue(BlUEPIN4, GREENPIN4, BLUEPIN4, 1);
    } 
    if(d == 'b'){
      runBlue(BlUEPIN4, GREENPIN4, BLUEPIN4, 2);
    }
    if(d=='c'){
      runBlue(BlUEPIN4, GREENPIN4, BLUEPIN4, 3);
    }
    if(d=='d'){
    ...
    char e =Serial.read();
    if(e == 'a'){
      runBlue(BlUEPIN5, GREENPIN5, BLUEPIN1, 5);
    } 
    if(e == 'b'){
      runBlue(BlUEPIN5, GREENPIN5, BLUEPIN5, 2);
    }
    if(e=='c'){
      runBlue(BlUEPIN5, GREENPIN5, BLUEPIN5, 3);
    }
    if(e=='d'){
...
if(Serial.available()>0){
    char f =Serial.read();
    if(f == 'a'){
      runBlue(BlUEPIN6, GREENPIN6, BLUEPIN6, 1);
    } 
    if(f == 'b'){
      runBlue(BlUEPIN6, GREENPIN6, BLUEPIN6, 2);
    }
    if(f=='c'){
      runBlue(BlUEPIN6, GREENPIN6, BLUEPIN6, 3);
    }
    if(f=='d'){
